...
include '../db1.php';
$sql="select * from $tbname where type='3' order by time desc";
...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 微楼书列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
